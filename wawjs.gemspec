...
require "wawjs/version"
$version = WawJS::Version.to_s
...
Gem::Specification.new do |s|
  ...
  s.summary = "waw.js - Thinking web applications differently"

  # A long description of this gem (required)
  #
  # The description should be more detailed than the summary.  For example,
  # you might wish to copy the entire README into the description.
  s.description = "waw.js is a heavy client web framework for developing web applications powered \nby coffeescript client-side and ruby/sinatra server side."
  
  # The URL of this gem home page (optional)
  s.homepage = "http://github.com/blambeau/wAw.js"
